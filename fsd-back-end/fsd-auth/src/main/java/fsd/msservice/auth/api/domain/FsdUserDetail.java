...
public class FsdUserDetail implements UserDetails {
     ...
     * @param roleNameArray
     */
    public FsdUserDetail(String userType, String userId, String username, String password, List<String> roleNameArray) {
        this.userType = userType;
        this.userId = userId;
        this.username = username;
        this.password = password;
        this.authorities = Stream.of(roleNameArray.toArray(new String[0])).map(s -> new SimpleGrantedAuthority(s))
